...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert('Boards', [
      ...
      { title: 'Test', user_id: 2, favorite: false, archive: false, createdAt: new Date(), updatedAt: new Date()},
      { title: 'Work', user_id: 1, favorite: false, archive: false, createdAt: new Date(), updatedAt: new Date()},
      { title: 'Dog Training', user_id: 2, favorite: false, archive: false, createdAt: new Date(), updatedAt: new Date()}
